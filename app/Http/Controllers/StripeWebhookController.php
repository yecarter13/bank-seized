...
class StripeWebhookController extends Controller
{
    ...
    protected function notifyAdmin($order): void
    {
        try {
            ...
            $body = "<p><strong>New order received!</strong></p>
...
<p><strong>Items:</strong><br>" . nl2br($items) . "</p>";
            Mail::to('pouabegille@gmail.com')->send(new AdminMail('New Order - #' . $order->order_number, $body));
        } catch (\Throwable $e) {
