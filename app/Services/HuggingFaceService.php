...
class HuggingFaceService
{
    ...
    {
        $systemPrompt = "You are an auto parts search assistant. Extract structured search parameters from the user's query. "
            . "Respond ONLY with a valid JSON object. Use these keys: brand, category, make, model, min_price, max_price, keywords. "
            . "Example: {\"keywords\": \"body kit\", \"make\": \"Volkswagen\", \"model\": \"Golf 7\", \"max_price\": 500} "
            . "Translate French terms to English. If a key has no value, omit it. DO NOT include any text outside the JSON.";
    ...
    {
        return "No parts found for your search. Try different keywords like \"brake discs Golf 7\" or \"headlight Peugeot 208\". "
            . "You can also browse our categories or use the search bar.";
    }
}
